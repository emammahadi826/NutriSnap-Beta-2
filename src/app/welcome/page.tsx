    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col flex-1">
                ...
                {/* Highlights Section */}
                <section className="w-full max-w-5xl mx-auto p-4 sm:p-8 md:p-12">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                        <div className="flex flex-col items-center gap-2 p-4 rounded-lg">
                            <Flame className="h-8 w-8 text-primary" />
                            <h3 className="font-semibold text-lg">Track Calories</h3>
                            <p className="text-muted-foreground text-sm">Log your meals effortlessly and keep an eye on your daily intake.</p>
                        </div>
                        <div className="flex flex-col items-center gap-2 p-4 rounded-lg">
                            <Target className="h-8 w-8 text-primary" />
                            <h3 className="font-semibold text-lg">Personalized Plans</h3>
                            <p className="text-muted-foreground text-sm">Get custom diet and fitness plans tailored to your goals.</p>
                        </div>
                        <div className="flex flex-col items-center gap-2 p-4 rounded-lg">
                            <TrendingUp className="h-8 w-8 text-primary" />
                            <h3 className="font-semibold text-lg">Progress Insights</h3>
                            <p className="text-muted-foreground text-sm">Visualize your journey with detailed reports and charts.</p>
                        </div>
                    </div>
                </section>

                {/* Testimonial Section */}
                <section className="w-full max-w-2xl mx-auto p-4 sm:p-8 md:p-12 text-center">
